 ...
 */
public class NestLocationsAttachmentHandler implements EntryAttachmentHandler<OutputStream> {
    ...
    @Override
    public void fromByteArray(byte[] bytes) throws NestException {
        ...
        try {
            ...
            while (type != null) {
                switch (type) {
                    case NAME:
                        System.out.println("READ nest location name " + byteArray.readUTF());
                        break;
                    case RELATIVE_TO:
                        System.out.println("READ nest location relative-to " + byteArray.readUTF());
                        break;
                    case PATH:
                        System.out.println("READ nest location path " + byteArray.readUTF());
                        break;
                    default:
    ...
    @Override
    public byte[] toByteArray(EntryBuildContext<OutputStream> ctx) throws NestException {

        final EntryLocation nestLocation = ctx.getEntrySource().getNestEntry().getNestLocation();
